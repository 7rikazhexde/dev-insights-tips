...
!!! note
    ...
    [Environment variables(export)](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-envvars.html) Or, you can set it up through [AWS CLI](../aws_cli-tips.md).
